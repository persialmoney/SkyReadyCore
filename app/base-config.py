...
def get_service_name(stage: str) -> str:
    """Get the name of the service for a given stage."""
    return f"{SERVICE_NAME}-{stage}"

def get_cluster_name(stage: str) -> str:
    """Get the name of the ECS cluster for a given stage."""
    return f"{PROJECT_NAME}Cluster-{stage}"

def get_task_family(stage: str) -> str:
    """Get the name of the task family for a given stage."""
    return f"{SERVICE_NAME}-{stage}"

def get_container_name(stage: str) -> str:
    """Get the name of the container for a given stage."""
    return f"{SERVICE_NAME}-{stage}"
